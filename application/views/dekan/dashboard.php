<div class="content">
    <h2 class="mb-4 text-primary">Dashboard Dekan</h2>
    <div class="card mb-4 shadow-sm border-0">
        <div class="card-body">
            <h5 class="text-dark">Selamat datang, <?php echo $nama; ?>!</h5>
            <p class="text-muted">Anda adalah Dekan. Berikut adalah ringkasan surat Anda:</p>
        </div>
    </div>
                ...
                <ul class="list-group list-group-flush">
                    <?php foreach ($surat_masuk as $surat): ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-dark"><?php echo $surat->judul_surat; ?></h6>
                                <p class="text-muted"><?php echo $surat->deskripsi; ?></p>
                                <small class="text-muted">Tanggal Masuk: <?php echo $surat->tanggal_masuk; ?></small>
                            </div>
    ...
    <div class="card mb-4 shadow-sm border-0">
        ...
        <div class="card-body">
            <?php if (empty($surat_diproses)): ?>
                <p class="text-muted">Tidak ada surat yang sedang diproses.</p>
            <?php else: ?>
                <ul class="list-group list-group-flush">
    ...
    <div class="card mb-4 shadow-sm border-0">
        ...
        <div class="card-body">
            <?php if (empty($surat_selesai)): ?>
                <p class="text-muted">Tidak ada surat yang telah selesai.</p>
            <?php else: ?>
                <ul class="list-group list-group-flush">
                    <?php foreach ($surat_selesai as $surat): ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-dark"><?php echo $surat->judul_surat; ?></h6>
                                <p class="text-muted"><?php echo $surat->deskripsi; ?></p>
                                <small class="text-muted">Tanggal Masuk: <?php echo $surat->tanggal_masuk; ?> | Selesai: <?php echo $surat->tanggal_selesai; ?></small>
                            </div>
